        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 font-weight-bold"><i class="fas fa-route  mr-2"></i></i>Routes</h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="card-header mt-3 mb-2">
                        <h5 class="mb-0 font-weight-bold"><i class="fas fa-plus-circle mr-2"></i></i>Add Route</h5>
                    </div>
                    ...
                    <div class="card-header mt-3 mb-2">
                        <h5 class="mb-0 font-weight-bold"><i class="fas fa-route mr-2"></i></i>Available Routes</h5>
                    </div>
                    <div class="card border-0 rounded px-3 py-3 my-2 shadow" >
                    <div class="row mx-5">
                            Available Route Loading...
                        </div>
                    </div>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="list-group">
                    ...
                    <a href="{{ route('admin-route') }}" class="list-group-item list-group-item-action active">
